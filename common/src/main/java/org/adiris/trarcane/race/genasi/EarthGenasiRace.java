...
public class EarthGenasiRace extends GenasiRace {

    public EarthGenasiRace() {
    ...
    public RaceConfig.Default getDefaultConfig() {
        return ((GenasiConfig) ConfigRegistry.getConfig(GenasiConfig.class)).EarthGenasiRace;
    }
    ...
    public Map<EvolutionRequirement, Float> getEvolutionRequirements(ManasRaceInstance previous, LivingEntity entity) {
        return Map.of(
                new EvolutionRequirement.EPRequirement(
                        ((GenasiConfig) ConfigRegistry.getConfig(GenasiConfig.class)).EarthGenasiRace.epRequirement
                ),
                100.0F
        );
    }
    ...
    public List<ManasSkill> getIntrinsicSkills(ManasRaceInstance instance, LivingEntity entity) {
        ...
        list.add((ManasSkill) io.github.manasmods.tensura.registry.skill.ExtraSkills.EARTH_MANIPULATION.get());
        list.add((ManasSkill) io.github.manasmods.tensura.registry.skill.ResistanceSkills.EARTH_ATTACK_RESISTANCE.get());
